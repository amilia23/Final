...
<?php
	$result = mysqli_query($mysqli, "SELECT * FROM student") or die($conn->error());
	?>
...
if($result){
    ...
    $sql = "UPDATE student SET matric = '$matric', name='$name', email='$email', password = '$password', phone='$phone' WHERE id='$login_session'";
